...
//! ## MuJoCo version
//!
//! MuJoCo-rs relies on MuJoCo [3.14.0](https://github.com/google-deepmind/mujoco/releases/tag/3.14.0).
//!
//! ## Documentation
//! A more guided documentation can be obtained [here](https://mujoco-rs.readthedocs.io/en/v7.0.x/).
//!
...
//! like described [here](https://mujoco-rs.readthedocs.io/en/v7.0.x/installation.html#static-linking).
//!
//! ## Model editing
