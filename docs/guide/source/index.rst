...
.. image:: https://img.shields.io/docsrs/mujoco-rs/7.0.0
    :target: https://docs.rs/mujoco-rs/7.0.0/mujoco_rs/
...
- ``viewer``: enables the Rust-native MuJoCo viewer.
  ...
  - ``viewer-ui``: enables the (additional) user UI within the viewer.
    This also allows users to add custom `egui <https://docs.rs/egui/0.36.1/egui/>`_ widgets to the viewer.
