...
geometry, MuJoCo introduced `Model Editing <https://mujoco.readthedocs.io/en/3.13.0/programming/modeledit.html>`_.
...
==============================
MuJoCo supports `default classes <https://mujoco.readthedocs.io/en/3.13.0/XMLreference.html#default>`_,
...
==========================
A `flexcomp <https://mujoco.readthedocs.io/en/3.13.0/XMLreference.html#body-flexcomp>`_ procedurally
