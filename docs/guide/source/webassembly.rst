...
<https://github.com/google-deepmind/mujoco/blob/3.14.0/wasm/README.md#prerequisites>`_,
...
::
    ...
    git clone https://github.com/google-deepmind/mujoco.git --branch 3.14.0 --depth 1
